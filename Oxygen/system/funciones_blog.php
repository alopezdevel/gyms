<?php
    ...
    function post_nuevo(){
        ...
        switch($visibilidad){
            case 1: $visibilidad = "publico"; break;
            case 2: $visibilidad = "privado"; break;
        }
        
        switch($categoria){
            case 1: $categoria = "blog"; break;
            case 2: $categoria = "noticia"; break;
        }
        switch($comentarios){
            case 1: $comentarios = "si"; break;
            case 2: $comentarios = "no"; break;
        }
        
        include("cn_usuarios.php");
        $dbconn->autocommit(FALSE); //Iniciamos Transaccion
    ...
    function get_entradas(){
        ...
        $sql       = "SELECT iConsecutivo, sNombreTitulo, eCategoria, eVisibilidad, sAutor, dFechaCreacion, bContenido ".
                     "FROM ct_blog_noticia WHERE eCategoria = '".$filtro_informacion."' AND eVisibilidad = 'publico' ORDER BY iConsecutivo DESC";
        $result    = $dbconn->query($sql) or die($dbconn->error);
        $htmlTabla = "";
        $countcont = 0;
        
        if($result->num_rows > 0){ 
            while($entradas = $result->fetch_assoc()){
               if($entradas["sNombreTitulo"] != ""){
                    ...
                    switch ($entradas["eCategoria"]) {
                        case "blog"   : $categoria = "fa-book"; $colorcategoria = "blog-categoria"; break;
                        case "noticia": $categoria = "fa-newspaper-o"; $colorcategoria = "noticia-categoria"; break;
                    }
        ...
        }else{$htmlTabla .="<div style=\"text-align:center; font-weight: bold;\">No hay entradas disponibles.</div>";}
    ...
    function get_entradacont(){
        ...
        $sql             = "SELECT iConsecutivo, sNombreTitulo, eCategoria, eVisibilidad, sAutor, dFechaCreacion, bContenido, eComentarios ".
                           "FROM ct_blog_noticia WHERE iConsecutivo = '".$identrada."'";
        $result          = $dbconn->query($sql) or die($dbconn->error);
        $htmlTabla       = "";
        $comentarios     = "";
        $cat_comentarios = "";
            ...
            while($entradas = $result->fetch_assoc()){
               if($entradas["sNombreTitulo"] != ""){
                    ...
                    $colorcategoria= "";
                     ...
                     switch($entradas["eCategoria"]){
                        case "blog"   : $categoria = "fa-book"; $colorcategoria = "blog-categoria"; $cat_comentarios = "entrada"; break;
                        case "noticia": $categoria = "fa-newspaper-o"; $colorcategoria = "noticia-categoria"; $cat_comentarios = "noticia"; break;
                     }
            
                     $htmlTabla .= "<div class=\"blog-entrada\">".
                                   "<span class=\"".$colorcategoria."\"><i class=\"fa ".$categoria."\"></i> ".$entradas["eCategoria"]."</span><h2>".$entradas["sNombreTitulo"]."</h2>".
                     ...
                     if($entradas["eComentarios"] == "si"){
                         ...
                         $htmlTabla .= "<div class=\"comentarios\">".
                                       "<div class=\"fb-comments\" data-href=\"http://oxygen-fx.laredo2.net/system/blog-contenido.php?".$cat_comentarios."=".$entradas["iConsecutivo"]."\" data-width=\"100%\" data-numposts=\"5\" data-colorscheme=\"light\"></div></div>".
                                       "</div>"; 
                         $comentarios =  $entradas["sNombreTitulo"];
                     }
                     else{$comentarios = "0";$htmlTabla .= "</div>";}
        ...
        else{$htmlTabla .="<div style=\"text-align:center; font-weight: bold;\">Esta entrada no se encuentra disponible.</div>";}
